...
const HomeGetYourOffer = () => {
  return (
    <section className="bg-[#f7f7f7] py-8 px-4 sm:px-8 md:px-12 lg:px-16">
      <div className="flex flex-col md:flex-row items-center justify-center h-[60vh] gap-16">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          className="w-full md:w-1/2 font-serif text-center md:text-left"
        >
          <h2 className="text-3xl md:text-4xl font-serif text-purple-900 mb-4 leading-tight">
